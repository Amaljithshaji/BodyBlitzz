      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
        ...
        RulerPicker(
          ...
          scaleLineStyleList: const [
            ...
            ScaleLineStyle(color: Colors.grey, width: 1, height: 60, scale: 5),
            ScaleLineStyle(color: Colors.grey, width: 1, height: 35, scale: -1)
          ],
        ...
        Text(
          ...
          style: GoogleFonts.roboto(fontWeight: FontWeight.bold, fontSize: 38),
        ),
        SizedBox(
          height: 7.h,
        ),
